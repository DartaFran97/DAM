...
public class Main {
	...
	public static void main(String[] args) {
			...
			// TODO Auto-generated method stub
					...
					String menu = "[ el juego consiste en adivinar la contraseña tras un total de 5 intentos se te dara un pista y el programa marcara aquellos numeros acertados. puedes seleccionar el modo con numero repetidos o sin repetir.";
