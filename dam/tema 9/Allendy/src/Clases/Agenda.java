...
public class Agenda {
    ...
    /**
     * Obtiene la lista de tareas de la agenda.
     * @return La lista de tareas de la agenda.
     */
    public ArrayList<Tarea>  getTareasAgenda() {
        return TareasAgenda;
    }

    /**
     * Establece la lista de tareas de la agenda.
     * @param tareasAgenda La nueva lista de tareas de la agenda.
     */
    public void setTareasAgenda(ArrayList<Tarea> tareasAgenda) {
        this.TareasAgenda = tareasAgenda;
    }
